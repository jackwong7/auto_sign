...
[task_local]
#城城领现金
0 0-23/1 * * * https://raw.githubusercontent.com/jackwong7/auto_sign/main/scripts/jd_city-joy.js, tag=城城领现金, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
 */
const $ = new Env('城城领现金');
...
let inviteCodes = [
  'HY3jyOulRgmkeoP1V5h_mup_44q0lLaSOfxNTSdQCY1YSw','RtGKzuWgRg-jKITOF9Y20p_pxsuZSs5Hik5acLQulDFq-tAtUQ'
]
!(async () => {
  if (!cookiesArr[0]) {
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({url: `http://107.172.97.176:8080/queryCityCode`, 'timeout': 10000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
          console.log(`${$.name} API请求失败，请检查网路重试`)
